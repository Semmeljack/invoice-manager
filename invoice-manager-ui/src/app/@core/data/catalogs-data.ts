...
export abstract class CatalogsData {
    abstract getAllClavesProductoServicio(
        page: number,
        size: number
    ): Promise<GenericPage<any>>;
    abstract getProductoServiciosByDescription(
        description: string
    ): Promise<ClaveProductoServicio[]>;
    abstract getProductoServiciosByClave(
        clave: string
    ): Promise<ClaveProductoServicio[]>;
    abstract getClaveUnidadCatalog(): Promise<ClaveUnidad[]>;
