...
public class UserController {
  ...
  @PutMapping("/{userId}")
  public ResponseEntity<UserDto> upadteUser(
      @PathVariable Integer userId, @RequestBody @Valid UserDto userDto) {
  ...
  public ResponseEntity<Void> deleteUserRoles(
  ...
  public ResponseEntity<RoleDto> insertRoleToUser(
      @PathVariable Integer userId, @RequestBody @Valid RoleDto roleDto) {
